...
public:
     ...
     */
    wxString Component2Vector( const wxString& aName, SIM_PLOT_TYPE aType,
     ...
     * @return SPT_VOLTAGE or SPT_CURRENT depending on aVector.
     */
    SIM_PLOT_TYPE Vector2Signal( const std::string& aVector, wxString& aSignal ) const;
