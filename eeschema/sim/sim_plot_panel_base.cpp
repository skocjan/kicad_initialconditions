...
SIM_PLOT_PANEL_BASE::SIM_PLOT_PANEL_BASE() : m_type( ST_INVALID )
{
}


SIM_PLOT_PANEL_BASE::SIM_PLOT_PANEL_BASE( enum SIM_TYPE aType ) : m_type( aType )
{
}
...
SIM_NOPLOT_PANEL::SIM_NOPLOT_PANEL( SIM_TYPE aType, wxWindow* parent, const wxPoint& pos,
        const wxSize& size, long style, const wxString& name )
        : SIM_PLOT_PANEL_BASE( aType ), wxPanel( parent, wxID_ANY, pos, size, style, name )
{
