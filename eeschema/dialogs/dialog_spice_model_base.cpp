...
DIALOG_SPICE_MODEL_BASE::DIALOG_SPICE_MODEL_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : DIALOG_SHIM( parent, id, title, pos, size, style )
{
	...
	m_useIC = new wxCheckBox( m_passive, wxID_ANY, _("IC"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer1->Add( m_useIC, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	m_IC = new wxTextCtrl( m_passive, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	m_IC->SetMinSize( wxSize( 200,-1 ) );

	fgSizer1->Add( m_IC, 0, wxALL|wxEXPAND, 5 );

	m_staticTextIC = new wxStaticText( m_passive, wxID_ANY, _("Initial value in TRAN sim."), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextIC->Wrap( -1 );
	fgSizer1->Add( m_staticTextIC, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	this->Connect( wxEVT_UPDATE_UI, wxUpdateUIEventHandler( DIALOG_SPICE_MODEL_BASE::onUpdateUI ) );
	m_pasType->Connect( wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler( DIALOG_SPICE_MODEL_BASE::onSelectPassiveTypeOrIC ), NULL, this );
	m_useIC->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( DIALOG_SPICE_MODEL_BASE::onSelectPassiveTypeOrIC ), NULL, this );
...
DIALOG_SPICE_MODEL_BASE::~DIALOG_SPICE_MODEL_BASE()
{
	...
	this->Disconnect( wxEVT_UPDATE_UI, wxUpdateUIEventHandler( DIALOG_SPICE_MODEL_BASE::onUpdateUI ) );
	m_pasType->Disconnect( wxEVT_COMMAND_COMBOBOX_SELECTED, wxCommandEventHandler( DIALOG_SPICE_MODEL_BASE::onSelectPassiveTypeOrIC ), NULL, this );
	m_useIC->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( DIALOG_SPICE_MODEL_BASE::onSelectPassiveTypeOrIC ), NULL, this );
