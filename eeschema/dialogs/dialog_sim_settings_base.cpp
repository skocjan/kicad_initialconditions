...
DIALOG_SIM_SETTINGS_BASE::DIALOG_SIM_SETTINGS_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : DIALOG_SHIM( parent, id, title, pos, size, style )
{
	...
	fgSizer125 = new wxFlexGridSizer( 0, 3, 0, 0 );
	fgSizer125->SetFlexibleDirection( wxBOTH );
	fgSizer125->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	m_staticText32 = new wxStaticText( this, wxID_ANY, _("Abs. tolerance:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText321 = new wxStaticText( this, wxID_ANY, _("Rel. tolerance:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText321->Wrap( -1 );
	fgSizer125->Add( m_staticText321, 0, wxALL, 5 );

	m_absTol1 = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer125->Add( m_absTol1, 0, wxALL, 5 );

	m_staticText11011 = new wxStaticText( this, wxID_ANY, _("%"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText11011->Wrap( -1 );
	fgSizer125->Add( m_staticText11011, 0, wxALL, 5 );


	bSizer1->Add( fgSizer125, 0, wxALL|wxEXPAND, 5 );
